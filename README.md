...
| [`docs/AUDIT_MODE.md`](docs/AUDIT_MODE.md) | Pointing a panel at a whole codebase — doc↔code drift, invariant sweeps, and why "review my architecture" is not a task |
